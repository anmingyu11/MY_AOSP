...
import android.view.IOnKeyguardVerifyResult;
...
interface IWindowManager
{
     ...
     * @hide
     */
    void verifyKeyguardSecurely(IOnKeyguardVerifyResult callback, String pwd);
     ...
     * @hide
     */
    void setAppUserOrientation(IApplicationToken token, int requestedOrientation,
            boolean freezeRotation);
    /**
     * @hide
     */
    int getAppUserOrientation(IApplicationToken token);

    /** @hide */
    boolean isFocusedWinFullScreen();
}
