...
public class SurfaceControl {
    ...
    /**
     * Surface creation flag: Creates Smartisan Extended surface for effects.
     * eg SMTFlip, wifi demo etc.
     */
    public static final int FX_SURFACE_SMTEXT = 0x00080000;
    ...
    //smartisanOS, add 3Dmatrix
    /** @hide */
    public static final int MATRIX_FLAG_MVP  = 1;
    /** @hide */
    public static final int MATRIX_FLAG_Z_3D = MATRIX_FLAG_MVP << 1;
    /** @hide */
    public static final int MATRIX_FLAG_MAX = MATRIX_FLAG_Z_3D;
    /** @hide need in transaction, as other operations*/
    public void setMatrix3D(float[] matrixArray, int usage) {
        checkNotReleased();//hbt, todo
        nativeSetMatrix3D(mNativeObject, matrixArray, usage);
    }
    private native void nativeSetMatrix3D(int nativeObject, float[] matrixArray, int usage);
}
