...
public interface WindowManagerPolicy {
    ...
    /**
     * @hide This key event should wake the device. To be returned from
     *       {@link #interceptKeyBeforeQueueing}. Do not return this and
     *       {@link #ACTION_GO_TO_SLEEP} or {@link #ACTION_PASS_TO_USER}.
     */
    public final static int ACTION_WAKE_UP_BY_HOME_BUTTON = 0x00000008;
    ...
    public interface ThumbModeFuncs {
        ...
        void requestTraversalToThumbMode(boolean doApply);

        void showThumbWallpaper();
    }
    ...
    /**
     * Smartisan keyguard feature request that
     *      "A window that is behind keyguard should be draw even when keyguard is on".
     *
     *  But in some cases top app window must be force hide.
     */
    public boolean mustForceHidden(WindowState win, WindowManager.LayoutParams attrs);
    ...
    /**
     * Callback used by {@link WindowManagerPolicy#verifyKeyguardSecurely}
     */
    interface OnKeyguardVerifyResult {
     ...
     * @hide
     */
    void verifyKeyguardSecurely(OnKeyguardVerifyResult callback, String pwd);

    /**
     * @hide
     */
    boolean isKeyguardVerified();
