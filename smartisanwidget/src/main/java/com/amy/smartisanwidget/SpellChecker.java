    ...
    private class SpellParser {
        ...
        public void parse() {
            ...
            if (mIsSentenceSpellCheckSupported) {
                ...
                if (wordStart > end) {
                    // It's not properly to set scheduleOtherSpellCheck=true just when
                    // wordIteratorWindowEnd<end. Because, there are many chances that
                    // we can get a spellCheckEnd larger than end. In these cases, it
                    // will crash at setRangeSpan.
