...
public class Toast {
    ...
    public static Toast makeText(Context context, CharSequence text, int duration) {
        ...
        TypedArray a = inflate.getContext().obtainStyledAttributes(null,
                com.android.internal.R.styleable.Toast,
                com.android.internal.R.attr.toastLayout, 0);

        View v = inflate.inflate(a.getResourceId(
                com.android.internal.R.styleable.Toast_layout,
